<template>
    <div class="card p-4 shadow mb-5" style="text-align: center">
        ...
        <form @submit.prevent="searchData()">
            <div class="row ">
                <div class="col">
                    <v-select label="namkuesxrole" :options="arrayKuesioner" v-model="query.query"
                        placeholder="Pilih Kuesioner" :reduce="(arrayKuesioner) => arrayKuesioner.namkuesxrole">
                    </v-select>
                </div>

                <div class="col">
                    <v-select label="namkat_xrole" :options="arrayKategori" v-model="query.id_katxrole"
        ...
        <div class="row justify-content-end">
            <div class="mb-1 d-flex justify-content-end" style="width: 310px">
                <div>
                    <router-link class="btn btn-success rounded" v-bind:to="{ name: 'AksiKuesionerXrole' }">Tambah Data <i
                            ...
                            <div class="modal-body">
                                <div class="row pt-3">
                                    ...
                                    <div class="col-md text-start">
                                        : {{ detailKuesioner.namkat_xrole }}
                                    </div>
                                </div>
                                <div class="row pt-3">
                                    <div class="col-md-3 text-start"><b>Kuesioner</b></div>
                                    <div class="col-md text-start">
                                        : {{ detailKuesioner.namkuesxrole }}
                                    </div>
                                </div>
                                <div class="row pt-3">
...
export default {
    ...
    methods: {
        getData() {
            ...
            axios.get("/api/auth/kues/xrole/list/kategori", config).then((response) => {
                this.arrayKategori = response.data;
            });
            axios.get("/api/auth/kues/xrole/list/kuesioner", config).then((response) => {
        ...
        deleteData(id) {
            ...
            if (confirm("Apakah Anda Ingin Menghapus Data Tersebut ?")) {
                axios.get(`/api/auth/kues/xrole/delete/` + id, config).then((response) => {
        ...
        searchData() {
            ...
            if (this.query.id_katxrole !== null) {
                this.url = this.url + "&id_katxrole=" + this.query.id_katxrole;
            }
        ...
        detailData(id) {
            ...
            axios.get("/api/auth/kues/xrole/edit/" + id, config).then((response) => {
                this.detailKuesioner = response.data.data;
                this.detailKuesioner = Object.assign(this.detailKuesioner, { namkat_xrole: this.detailKuesioner.kategori.namkat_xrole });
