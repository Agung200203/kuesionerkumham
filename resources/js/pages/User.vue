    ...
    <div class="container">
        <div class="card p-4 shadow mb-5" style="text-align: center">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <input class="form-control form-control-sm" id="nama" type="text" placeholder="Nama..."
            ...
            <div class="row justify-content-end">
                <div class="mb-1 d-flex justify-content-end" style="width: 310px">
                    <div>
                        <router-link type="button" class="btn btn-success" v-bind:to="{ name: 'Edit' }"
                    ...
                    <table class="table table-striped table-hover" id="scrol">
                        ...
                        <tbody>
                            <tr v-for="(dt, index) in results">
                                ...
                                <td>{{ dt.nbi }}</td>
                                <td>
                                    <b-dropdown id="dropdown-right" right text="Aksi" variant="success" class="m-2"
                                        size="sm">
                                        <b-dropdown-item href="#">Detail</b-dropdown-item>

                                        <b-dropdown-item @click.prevent="editData(dt.id)">Edit</b-dropdown-item>

                                        <b-dropdown-item @click.prevent="deleteData(dt.id)">Hapus</b-dropdown-item>
                                    </b-dropdown>
                                </td>
                            </tr>
                        </tbody>
