...
class CreateLapMasterPenilaianspeedec extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lap_master_penilaianspeedec', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('lap_master_penilaianspeedec');
    }
}
