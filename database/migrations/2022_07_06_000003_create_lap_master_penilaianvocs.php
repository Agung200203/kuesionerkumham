...
class CreateLapMasterPenilaianvocs extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lap_master_penilaianvocs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('lap_master_penilaianvocs');
    }
}
