...
class CreateMasterPenilaianproact extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_penilaianproact', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('master_penilaianproact');
    }
}
