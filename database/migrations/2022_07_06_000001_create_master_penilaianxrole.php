...
class CreateMasterPenilaianxrole extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_penilaianxrole', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('master_penilaianxrole');
    }
}
